...
export const useGetMyOrders=()=>{
    ...
    //in orders page to make status get updated automatically without the need of refreshing for user
    //refetchInterval is added to useQuery of useGetMyOrders hook 
...
export const useCreateCheckoutSession=()=>{
    ...
    if(error){
        ...
        reset();//error msg wont appear continuously
    }
