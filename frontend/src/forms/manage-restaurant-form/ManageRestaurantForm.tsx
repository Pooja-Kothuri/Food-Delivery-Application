...
const formSchema=z.object({
   ...
   country:z.string({
    ...
    deliveryPrice:z.coerce.number({//coerce converts string to specified datatype
        required_error:"delivery time  is required",
        invalid_type_error:"must be a valid number",
    }),
   estimatedDeliveryTime:z.coerce.number({//coerce converts string to specified datatype
...
const ManageRestaurantForm = ({onSave,isLoading,restaurant}:Props) => {
   ...
   //TODO - convert formDataJSON to new formData obj
    ...
    //data  is sent in form data not in applicaton/json to backend
   ...
   return (//shadcn form
   //form component uses  appcontext to pass all form properties to child properties so thats why we can use context in detailssection.tsx using useFormContext
     <Form {...form}>
         <form 
